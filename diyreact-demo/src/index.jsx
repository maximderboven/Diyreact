...
const element = <div><h1>Maxim Derboven</h1><div><p>This is a paragraph</p></div></div>
const element2 = <div><h1>Programmeren 3</h1><div><p>Hij ondersteunt gelukkig ook nummers, anders was het <strong>programmeren drie</strong> ofni</p></div></div>
